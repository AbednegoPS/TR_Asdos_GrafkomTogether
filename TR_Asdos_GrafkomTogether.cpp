...
void tampil(void)
{
    ...
    //Kursi Luar Kiri
    glBegin(GL_QUADS);
    glColor3f(0.86, 0.92, 0.70);
    glVertex3f(-70.0, -15, -27.0);
    glVertex3f(-72.0, -15, -27.0);
    glVertex3f(-72.0, -15, -25.0);
    glVertex3f(-70.0, -15, -25.0);
    glEnd();

    glBegin(GL_QUADS);
    glColor3f(0.86, 0.92, 0.70);
    glVertex3f(-70.0, -5, -27.0);
    glVertex3f(-72.0, -5, -27.0);
    glVertex3f(-72.0, -5, -25.0);
    glVertex3f(-70.0, -5, -25.0);
    glEnd();
    ...
    glBegin(GL_QUADS);
    glColor3f(0.86, 0.92, 0.70);
    glVertex3f(-70.0, -15, -10.0);
    glVertex3f(-72.0, -15, -10.0);
    glVertex3f(-72.0, -15, -8.0);
    glVertex3f(-70.0, -15, -8.0);
    glEnd();

    glBegin(GL_QUADS);
    glColor3f(0.86, 0.92, 0.70);
    glVertex3f(-70.0, -5, -10.0);
    glVertex3f(-72.0, -5, -10.0);
    glVertex3f(-72.0, -5, -8.0);
    glVertex3f(-70.0, -5, -8.0);
    glEnd();
    ...
    glBegin(GL_QUADS);
    glColor3f(0.86, 0.92, 0.70);
    glVertex3f(-78.0, -15, -27.0);
    glVertex3f(-80.0, -15, -27.0);
    glVertex3f(-80.0, -15, -25.0);
    glVertex3f(-78.0, -15, -25.0);
    glEnd();

    glBegin(GL_QUADS);
    glColor3f(0.86, 0.92, 0.70);
    glVertex3f(-78.0, -5, -27.0);
    glVertex3f(-80.0, -5, -27.0);
    glVertex3f(-80.0, -5, -25.0);
    glVertex3f(-78.0, -5, -25.0);
    glEnd();
    ...
    glBegin(GL_QUADS);
    glColor3f(0.86, 0.92, 0.70);
    glVertex3f(-78.0, -15, -10.0);
    glVertex3f(-80.0, -15, -10.0);
    glVertex3f(-80.0, -15, -8.0);
    glVertex3f(-78.0, -15, -8.0);
    glEnd();

    glBegin(GL_QUADS);
    glColor3f(0.86, 0.92, 0.70);
    glVertex3f(-78.0, -5, -10.0);
    glVertex3f(-80.0, -5, -10.0);
    glVertex3f(-80.0, -5, -8.0);
    glVertex3f(-78.0, -5, -8.0);
    glEnd();
    ...
    glBegin(GL_QUADS);
    glColor3f(0.86, 0.92, 0.70);
    glVertex3f(-70.0, -5, -33.0);
    glVertex3f(-82.0, -5, -33.0);
    glVertex3f(-82.0, -5, -2.0);
    glVertex3f(-70.0, -5, -2.0);
    glEnd();

    glBegin(GL_QUADS);
    glColor3f(0.86, 0.92, 0.70);
    glVertex3f(-70.0, 8, -33.0);
    glVertex3f(-70.0, -5, -33.0);
    glVertex3f(-70.0, -5, -2.0);
    glVertex3f(-70.0, 8, -2.0);
    glEnd();
    ...
    glVertex3f(46.9, -10.5, -32.0);
    glVertex3f(47.9, -10.5, -32.0);
    glVertex3f(47.9, 10.5, -32.0);
    glVertex3f(46.9, 10.5, -32.0);
    glEnd();
    //Kanan
    ...
    glVertex3f(44.0, 10.5, -30.0);
    glVertex3f(50.0, 10.5, -30.0);
    glVertex3f(50.0, 15.5, -30.0);
    glVertex3f(44.0, 15.5, -30.0);
    glEnd();
    //Kanan
    glBegin(GL_QUADS);
    glColor3f(0.0, 0.8, 0.0);
    glVertex3f(50.0, 10.5, -35.0);
    glVertex3f(50.0, 10.5, -30.0);
    glVertex3f(50.0, 15.5, -30.0);
    glVertex3f(50.0, 15.5, -35.0);
    glEnd();
    //Kiri
    glBegin(GL_QUADS);
    glColor3f(0.0, 0.8, 0.0);
    glVertex3f(44.0, 10.5, -35.0);
    glVertex3f(44.0, 10.5, -30.0);
    glVertex3f(44.0, 15.5, -30.0);
    glVertex3f(44.0, 15.5, -35.0);
    glEnd();
    //Belakang
    glBegin(GL_QUADS);
    ...
    //Alas Lap Basket
    glBegin(GL_QUADS);
    glColor3f(0.46, 0.18, 0.04);
    glVertex3f(100.0, -15, -60.0);
    glVertex3f(120.0, -15, -60.0);
    glVertex3f(120.0, -15, 55.0);
    glVertex3f(100.0, -15, 55.0);
    glEnd();

    //Ring
    glBegin(GL_QUADS);
    glColor3f(0.02, 0.05, 0.46);
    glVertex3f(108.0, -14.9, -56.0);
    glVertex3f(111.0, -14.9, -56.0);
    glVertex3f(111.0, -14.9, -54.0);
    glVertex3f(108.0, -14.9, -54.0);
    glEnd();

    glBegin(GL_QUADS);
    glColor3f(0.02, 0.05, 0.46);
    glVertex3f(108.0, 30, -56.0);
    glVertex3f(111.0, 30, -56.0);
    glVertex3f(111.0, 30, -54.0);
    glVertex3f(108.0, 30, -54.0);
    glEnd();
    ...
    glBegin(GL_QUADS);
    glColor3f(0.02, 0.05, 0.46);
    glVertex3f(108.0, -14.9, 49.0);
    glVertex3f(111.0, -14.9, 49.0);
    glVertex3f(111.0, -14.9, 51.0);
    glVertex3f(108.0, -14.9, 51.0);
    glEnd();

    glBegin(GL_QUADS);
    glColor3f(0.02, 0.05, 0.46);
    glVertex3f(108.0, 30, 49.0);
    glVertex3f(111.0, 30, 49.0);
    glVertex3f(111.0, 30, 51.0);
    glVertex3f(108.0, 30, 51.0);
    glEnd();
    ...
    glVertex3f(100.0, 15.0, 48.9);
    glVertex3f(120.0, 15.0, 48.9);
    glVertex3f(120.0, 40.0, 48.9);
    glVertex3f(100.0, 40.0, 48.9);
    glEnd();

    glBegin(GL_QUADS);
    glColor3f(0.83, 0.45, 0.45);
    glVertex3f(108.0, 25.0, 48.8);
    glVertex3f(112.0, 25.0, 48.8);
    glVertex3f(112.0, 30.0, 48.8);
    glVertex3f(108.0, 30.0, 48.8);
    glEnd();

    glBegin(GL_QUADS);
    glColor3f(0.83, 0.07, 0.07);
    glVertex3f(100.0, 15.0, -53.9);
    glVertex3f(120.0, 15.0, -53.9);
    glVertex3f(120.0, 40.0, -53.9);
    glVertex3f(100.0, 40.0, -53.9);
    glEnd();

    glBegin(GL_QUADS);
    glColor3f(0.83, 0.45, 0.45);
    glVertex3f(108.0, 25.0, -53.8);
    glVertex3f(112.0, 25.0, -53.8);
    glVertex3f(112.0, 30.0, -53.8);
    glVertex3f(108.0, 30.0, -53.8);
    glEnd();

    glBegin(GL_LINE_LOOP);
    glColor3f(0.3, 0.3, 0.3);
    glVertex3f(108.0, 25, 48.8);
    glVertex3f(112.0, 25, 48.8);
    glVertex3f(112.0, 25, 44.8);
    glVertex3f(108.0, 25, 44.8);
    glEnd();

    glBegin(GL_LINE_LOOP);
    glColor3f(0.3, 0.3, 0.3);
    glVertex3f(108.0, 25, -53.8);
    glVertex3f(112.0, 25, -53.8);
    glVertex3f(112.0, 25, -49.8);
    glVertex3f(108.0, 25, -49.8);
    glEnd();
